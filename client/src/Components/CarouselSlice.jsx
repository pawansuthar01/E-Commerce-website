function CarouselSlide({ image, title, slideNumber, description }) {
  ...
  return (
    <div
      ...
      className=" relative carousel-item  max-sm:w-[100%] w-full max-sm:h-[400px] h-[550px] justify-center flex flex-row-reverse bg-gradient-to-r from-white via-[#ece6d8] to-whitecarousel-slide   transition-transform duration-800 ease-linear "
    >
